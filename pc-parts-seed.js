...
const GPUS = [
  ...
  { seedId:'gpu-rtx-4070ti',    brand:'NVIDIA', name:'GeForce RTX 4070 Ti',        specs:{ tdp:285, pcie8pin:2 } },
  { seedId:'gpu-rtx-4070tis',   brand:'NVIDIA', name:'GeForce RTX 4070 Ti SUPER',  specs:{ tdp:285, pcie8pin:2 } },
  { seedId:'gpu-rtx-4080',      brand:'NVIDIA', name:'GeForce RTX 4080',           specs:{ tdp:320, pcie12vhpwr:true } },
  { seedId:'gpu-rtx-3070',      brand:'NVIDIA', name:'GeForce RTX 3070',           specs:{ tdp:220, pcie8pin:2 } },
  { seedId:'gpu-rtx-3070ti',    brand:'NVIDIA', name:'GeForce RTX 3070 Ti',        specs:{ tdp:290, pcie8pin:2 } },
  { seedId:'gpu-rtx-3080',      brand:'NVIDIA', name:'GeForce RTX 3080',           specs:{ tdp:320, pcie8pin:2 } },
  { seedId:'gpu-rtx-3080ti',    brand:'NVIDIA', name:'GeForce RTX 3080 Ti',        specs:{ tdp:350, pcie8pin:2 } },
  { seedId:'gpu-rtx-3090',      brand:'NVIDIA', name:'GeForce RTX 3090',           specs:{ tdp:350, pcie8pin:2 } },
  { seedId:'gpu-rx-6600xt',     brand:'AMD',    name:'Radeon RX 6600 XT',          specs:{ tdp:160, pcie8pin:1 } },
  { seedId:'gpu-rx-6650xt',     brand:'AMD',    name:'Radeon RX 6650 XT',          specs:{ tdp:180, pcie8pin:1 } },
  { seedId:'gpu-rx-6800xt',     brand:'AMD',    name:'Radeon RX 6800 XT',          specs:{ tdp:300, pcie8pin:2 } },
  { seedId:'gpu-rx-7600xt',     brand:'AMD',    name:'Radeon RX 7600 XT',          specs:{ tdp:190, pcie8pin:2 } },
  { seedId:'gpu-rx-7900xtx',    brand:'AMD',    name:'Radeon RX 7900 XTX',         specs:{ tdp:355, pcie8pin:2 } },
...
const CASES = [
  { seedId:'case-4000d-airflow-white', brand:'Corsair', name:'4000D Airflow (White)', verify:true,
    specs:{ colour:'White', maxBoardFormFactor:'ATX', maxGpuLengthMm:360, maxCoolerHeightMm:170, maxPsuLengthMm:180, psuFormFactor:'ATX', radiatorMm:360, bays35:2, bays25:2, fanMounts:6, fansIncluded:2 } },
  { seedId:'case-north-white', brand:'Fractal Design', name:'North (Chalk White)', verify:true,
    specs:{ colour:'White', maxBoardFormFactor:'ATX', maxGpuLengthMm:355, maxCoolerHeightMm:170, psuFormFactor:'ATX', radiatorMm:360, bays35:2, bays25:2, fanMounts:6, fansIncluded:3 } },
  { seedId:'case-o11-evo-white', brand:'Lian Li', name:'O11 Dynamic EVO (White)', verify:true,
    specs:{ colour:'White', maxBoardFormFactor:'E-ATX', maxGpuLengthMm:420, maxCoolerHeightMm:167, psuFormFactor:'ATX', radiatorMm:360, bays35:2, bays25:4, fanMounts:10, fansIncluded:0 } },
  { seedId:'case-h5-flow-white', brand:'NZXT', name:'H5 Flow (White)', verify:true,
    specs:{ colour:'White', maxBoardFormFactor:'ATX', maxGpuLengthMm:365, maxCoolerHeightMm:165, psuFormFactor:'ATX', radiatorMm:280, bays35:1, bays25:2, fanMounts:7, fansIncluded:2 } },
  { seedId:'case-nr200p-white', brand:'Cooler Master', name:'NR200P (White)', verify:true,
    specs:{ colour:'White', maxBoardFormFactor:'Mini-ITX', maxGpuLengthMm:330, maxCoolerHeightMm:155, psuFormFactor:'SFX', radiatorMm:280, bays35:0, bays25:3, fanMounts:6, fansIncluded:2 } },
  { seedId:'case-4000d-airflow', brand:'Corsair', name:'4000D Airflow', verify:true,
    specs:{ colour:'Black', maxBoardFormFactor:'ATX', maxGpuLengthMm:360, maxCoolerHeightMm:170, maxPsuLengthMm:180, psuFormFactor:'ATX', radiatorMm:360, bays35:2, bays25:2, fanMounts:6, fansIncluded:2 } },
  { seedId:'case-5000d-airflow', brand:'Corsair', name:'5000D Airflow', verify:true,
    specs:{ colour:'Black', maxBoardFormFactor:'E-ATX', maxGpuLengthMm:420, maxCoolerHeightMm:170, maxPsuLengthMm:180, psuFormFactor:'ATX', radiatorMm:360, bays35:2, bays25:4, fanMounts:10, fansIncluded:2 } },
  { seedId:'case-north',         brand:'Fractal Design', name:'North', verify:true,
    specs:{ colour:'Black', maxBoardFormFactor:'ATX', maxGpuLengthMm:355, maxCoolerHeightMm:170, psuFormFactor:'ATX', radiatorMm:360, bays35:2, bays25:2, fanMounts:6, fansIncluded:3 } },
  { seedId:'case-meshify-2',     brand:'Fractal Design', name:'Meshify 2', verify:true,
    specs:{ colour:'Black', maxBoardFormFactor:'E-ATX', maxGpuLengthMm:360, maxCoolerHeightMm:185, psuFormFactor:'ATX', radiatorMm:360, bays35:4, bays25:2, fanMounts:9, fansIncluded:3 } },
  { seedId:'case-define-7',      brand:'Fractal Design', name:'Define 7', verify:true,
    specs:{ colour:'Black', maxBoardFormFactor:'E-ATX', maxGpuLengthMm:360, maxCoolerHeightMm:185, psuFormFactor:'ATX', radiatorMm:360, bays35:6, bays25:2, fanMounts:9, fansIncluded:3 } },
  { seedId:'case-lancool-216',   brand:'Lian Li', name:'Lancool 216', verify:true,
    specs:{ colour:'Black', maxBoardFormFactor:'ATX', maxGpuLengthMm:392, maxCoolerHeightMm:180, psuFormFactor:'ATX', radiatorMm:360, bays35:2, bays25:2, fanMounts:7, fansIncluded:3 } },
  { seedId:'case-o11-evo',       brand:'Lian Li', name:'O11 Dynamic EVO', verify:true,
    specs:{ colour:'Black', maxBoardFormFactor:'E-ATX', maxGpuLengthMm:420, maxCoolerHeightMm:167, psuFormFactor:'ATX', radiatorMm:360, bays35:2, bays25:4, fanMounts:10, fansIncluded:0 } },
  { seedId:'case-h5-flow',       brand:'NZXT', name:'H5 Flow', verify:true,
    specs:{ colour:'Black', maxBoardFormFactor:'ATX', maxGpuLengthMm:365, maxCoolerHeightMm:165, psuFormFactor:'ATX', radiatorMm:280, bays35:1, bays25:2, fanMounts:7, fansIncluded:2 } },
  { seedId:'case-h7-flow',       brand:'NZXT', name:'H7 Flow', verify:true,
    specs:{ colour:'Black', maxBoardFormFactor:'ATX', maxGpuLengthMm:400, maxCoolerHeightMm:185, psuFormFactor:'ATX', radiatorMm:360, bays35:2, bays25:4, fanMounts:7, fansIncluded:2 } },
  { seedId:'case-nr200p',        brand:'Cooler Master', name:'NR200P', verify:true,
    specs:{ colour:'Black', maxBoardFormFactor:'Mini-ITX', maxGpuLengthMm:330, maxCoolerHeightMm:155, psuFormFactor:'SFX', radiatorMm:280, bays35:0, bays25:3, fanMounts:6, fansIncluded:2 } },
  { seedId:'case-p400a',         brand:'Phanteks', name:'Eclipse P400A', verify:true,
    specs:{ colour:'Black', maxBoardFormFactor:'ATX', maxGpuLengthMm:420, maxCoolerHeightMm:160, psuFormFactor:'ATX', radiatorMm:360, bays35:2, bays25:2, fanMounts:7, fansIncluded:3 } },
];
...
const COOLERS = [
  { seedId:'cool-stock',        brand:'Generic', name:'Stock boxed cooler', verify:true,
    specs:{ colour:'Black', coolerType:'Air', sockets:['AM5','AM4','LGA1700'], heightMm:70, tdpRating:65 } },
  { seedId:'cool-ak400',        brand:'DeepCool', name:'AK400', verify:true,
    specs:{ colour:'Black', coolerType:'Air', sockets:ALL_MODERN_SOCKETS, heightMm:155, tdpRating:150 } },
  { seedId:'cool-ak620',        brand:'DeepCool', name:'AK620', verify:true,
    specs:{ colour:'Black', coolerType:'Air', sockets:ALL_MODERN_SOCKETS, heightMm:160, tdpRating:260 } },
  { seedId:'cool-pa120',        brand:'Thermalright', name:'Peerless Assassin 120 SE', verify:true,
    specs:{ colour:'Black', coolerType:'Air', sockets:ALL_MODERN_SOCKETS, heightMm:155, tdpRating:245 } },
  { seedId:'cool-hyper212',     brand:'Cooler Master', name:'Hyper 212 Black Edition', verify:true,
    specs:{ colour:'Black', coolerType:'Air', sockets:ALL_MODERN_SOCKETS, heightMm:159, tdpRating:150 } },
  { seedId:'cool-nh-u12s',      brand:'Noctua', name:'NH-U12S redux', verify:true,
    specs:{ colour:'Black', coolerType:'Air', sockets:ALL_MODERN_SOCKETS, heightMm:158, tdpRating:160 } },
  { seedId:'cool-nh-d15',       brand:'Noctua', name:'NH-D15', verify:true,
    specs:{ colour:'Black', coolerType:'Air', sockets:ALL_MODERN_SOCKETS, heightMm:165, tdpRating:250 } },
  { seedId:'cool-nh-l9i',       brand:'Noctua', name:'NH-L9i (low profile)', verify:true,
    specs:{ colour:'Black', coolerType:'Air', sockets:['LGA1700','LGA1851'], heightMm:37, tdpRating:65 } },
  { seedId:'cool-aio-240',      brand:'Generic', name:'240mm AIO liquid cooler', verify:true,
    specs:{ colour:'Black', coolerType:'Liquid (AIO)', sockets:ALL_MODERN_SOCKETS, radiatorMm:240, tdpRating:200 } },
  { seedId:'cool-aio-280',      brand:'Generic', name:'280mm AIO liquid cooler', verify:true,
    specs:{ colour:'Black', coolerType:'Liquid (AIO)', sockets:ALL_MODERN_SOCKETS, radiatorMm:280, tdpRating:250 } },
  { seedId:'cool-aio-360',      brand:'Generic', name:'360mm AIO liquid cooler', verify:true,
    specs:{ colour:'Black', coolerType:'Liquid (AIO)', sockets:ALL_MODERN_SOCKETS, radiatorMm:360, tdpRating:300 } },
];

const FANS = [
  { seedId:'fan-120',    brand:'Generic', name:'120mm case fan',      specs:{ colour:'Black', sizeMm:120, watts:2 } },
  { seedId:'fan-140',    brand:'Generic', name:'140mm case fan',      specs:{ colour:'Black', sizeMm:140, watts:3 } },
  { seedId:'fan-120-pwm',brand:'Generic', name:'120mm PWM case fan',  specs:{ colour:'Black', sizeMm:120, watts:2 } },
];
