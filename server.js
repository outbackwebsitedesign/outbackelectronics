    ...
    fs.readFile(filePath, (err, data) => {
      ...
      const securityHeaders = isHtml ? {
        ...
        'Content-Security-Policy': isEmbeddable
          ...
          : "default-src 'self'; script-src 'self' 'unsafe-inline' https://*.tawk.to https://embed.tawk.to https://static.cloudflareinsights.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://*.tawk.to; img-src 'self' data: https:; font-src 'self' data: https://fonts.gstatic.com https://*.tawk.to; connect-src 'self' https://portal.outbackelectronics.com.au https://forum.outbackelectronics.com.au https://nominatim.openstreetmap.org wss://*.tawk.to https://*.tawk.to https://va.tawk.to https://cloudflareinsights.com; frame-src https://www.openstreetmap.org https://*.tawk.to; frame-ancestors 'none';",
      } : { 'X-Content-Type-Options': 'nosniff' };
      res.writeHead(200, {
...
function serveIndexWithOg(res, og) {
  ...
  fs.readFile(distPath, 'utf8', (err, template) => {
    ...
    res.writeHead(200, {
      ...
      'X-Content-Type-Options': 'nosniff',
      'Referrer-Policy': 'strict-origin-when-cross-origin',
      'Content-Security-Policy': "default-src 'self'; script-src 'self' 'unsafe-inline' https://*.tawk.to https://embed.tawk.to https://static.cloudflareinsights.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://*.tawk.to; img-src 'self' data: https:; font-src 'self' data: https://fonts.gstatic.com https://*.tawk.to; connect-src 'self' https://portal.outbackelectronics.com.au https://forum.outbackelectronics.com.au https://nominatim.openstreetmap.org wss://*.tawk.to https://*.tawk.to https://va.tawk.to https://cloudflareinsights.com; frame-src 'self' https://www.openstreetmap.org https://*.tawk.to; frame-ancestors 'none';",
    });
    res.end(html);
  });
}
