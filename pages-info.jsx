...
function TermsContent({ email, phone, address }) {
  ...
  return (
    <div>
      ...
      <div style={s.mt}><h3>19. Governing Law</h3>
      ...
      <div style={s.mt}><h3>21. Corrections</h3><p style={s.p}>We may correct typographical errors, inaccuracies, or omissions in our content at any time without prior notice. We are not liable for any reliance placed on content that is later corrected.</p></div>
      <div style={s.mt}><h3>22. Disclaimer and Assumption of Risk</h3>
        ...
        <p style={s.p}><strong>Technical Information.</strong> Any technical information, advice, guides, tutorials, or recommendations made available through the Services (including the forum, repair guides, and product descriptions) are provided for general informational purposes only and do not constitute professional advice. You acknowledge that electronic repairs and modifications involve inherent risks including damage to property, voiding of manufacturer warranties, and potential safety hazards. You assume all risk associated with acting on any technical information obtained through the Services and agree that we shall not be liable for any loss, damage, injury, or adverse outcome resulting from reliance on such information.</p>
      ...
      <div style={s.mt}><h3>24. Indemnification</h3>
      ...
      <div style={s.mt}><h3>28. Miscellaneous</h3>
      ...
      <div style={s.mt}><h3>29. Contact Us</h3>
  ...
  return (
    <div>
      ...
      <div style={s.mt}><h3>Technical Information Disclaimer</h3>
        <p style={s.p}>Any technical information, repair guides, product specifications, tutorials, forum posts, or other technical content available on this Site are provided for general informational purposes only. They do not constitute professional engineering, electrical, or safety advice. Electronic repairs and modifications involve inherent risks, including risk of electric shock, fire, damage to equipment, personal injury, and voiding of manufacturer warranties.</p>
        <p style={{...s.p, textTransform:'uppercase', fontSize:13}}>YOU ASSUME ALL RISK AND RESPONSIBILITY FOR ANY ACTIONS TAKEN IN RELIANCE ON TECHNICAL INFORMATION OBTAINED FROM THIS SITE. WE SHALL HAVE NO LIABILITY WHATSOEVER FOR ANY LOSS, DAMAGE, INJURY, DEATH, PROPERTY DAMAGE, CONSEQUENTIAL HARM, OR OTHER ADVERSE OUTCOME RESULTING FROM YOUR USE OF OR RELIANCE ON ANY TECHNICAL INFORMATION ON THIS SITE. YOU SHOULD ALWAYS CONSULT A QUALIFIED PROFESSIONAL BEFORE UNDERTAKING ANY ELECTRICAL OR ELECTRONIC REPAIR OR MODIFICATION.</p>
      </div>
