  ...
  return (
    <div>
      ...
      <div style={s.mt}><h3>2. Ownership of Deliverables — We Retain IP, You Get a Licence</h3>
        ...
        <p style={s.p}>No licence is granted, and no Deliverable will be released to you, until the job is paid in full. We may withhold source files, firmware images, or design files (while still providing the finished physical item, where applicable) until payment is received, unless a specific quote or statement of work for the job otherwise agrees to deliver source files or design files on a different basis — in which case that written agreement prevails over this clause for that job.</p>
      </div>
      ...
      <div style={s.mt}><h3>3. Reverse Engineering — Your Warranty</h3>
        ...
        <ul style={{paddingLeft:20, lineHeight:2, marginTop:8}}>
          ...
          <li>you are not aware of any patent, registered design, copyright, or trade mark rights that would prevent the requested work, and have not been told by any third party that the item or its underlying design is subject to such rights; you do not breach, and have no reason to believe the work would breach, the anti-circumvention provisions of the <em>Copyright Act 1968</em> (Cth) or any other applicable law; and</li>
          <li>you have not misrepresented your relationship to, or rights in, the item.</li>
        </ul>
        <p style={s.p}>We recognise that most customers cannot exhaustively verify patent or design-registration status before requesting reverse-engineering work, which is why this warranty is limited to what you are actually aware of or have been told, rather than requiring you to conduct a search.</p>
        <p style={s.p}>To the extent permitted by law, you indemnify us against any claim, loss, or liability arising from reverse-engineering work we perform at your request where any part of this warranty is false.</p>
      </div>
      ...
      <div style={s.mt}><h3>5. Risks Specific to Custom and Reverse-Engineered Work</h3>
        ...
        <ul style={{paddingLeft:20, lineHeight:2, marginTop:8}}>
          ...
          <li><strong>Not a medical device; not safety-certified.</strong> Custom Work is not designed, tested, or certified as a medical device under the <em>Therapeutic Goods Act 1989</em> (Cth) or any other medical device regulatory framework, and must not be used for diagnosis, treatment, monitoring, or any other medical purpose unless we expressly agree in writing to develop the Deliverable to that standard (which involves a separate, materially different scope, cost, and regulatory pathway). The same applies to any other safety-critical regulated application (e.g. aviation, automotive safety systems). Using a Deliverable for a medical or other safety-critical regulated purpose without our express written agreement to that scope is entirely at your own risk.</li>
      ...
      <div style={s.mt}><h3>7. Warranty on Custom Work</h3>
        ...
        <p style={s.p}><strong>Nothing in this policy excludes, restricts, or modifies any right or remedy you have under the Australian Consumer Law, or any other applicable law, that cannot lawfully be excluded, restricted, or modified.</strong></p>
      </div>

      <div style={s.mt}><h3>7A. Limitation of Liability</h3>
        <p style={s.p}>To the maximum extent permitted by law, our total liability arising out of or in connection with Custom Work performed for you, whether in contract, tort (including negligence), or otherwise, is limited to the fees paid by you for the relevant job. We are not liable for any indirect, consequential, or economic loss, including loss of profits, loss of contracts, or loss of business opportunity, arising out of or in connection with Custom Work.</p>
        <p style={s.p}>This limitation does not apply to liability that cannot lawfully be excluded or limited, including any ACL consumer guarantee that applies to your purchase, or to our indemnity obligations under clause 3.</p>
      </div>

      <div style={s.mt}><h3>7B. Digital Forensics and Data Recovery — Your Warranty</h3>
        <p style={s.p}>If you ask us to perform digital forensics, data recovery, or extraction of data from a computer, phone, storage media, or embedded device, you warrant to us that:</p>
        <ul style={{paddingLeft:20, lineHeight:2, marginTop:8}}>
          <li>you own the device or data, or you have the lawful authority of the owner, your employer (for a work-issued device, in accordance with your organisation's policies), or a court order or other legal process to have it examined;</li>
          ...
          <li>you will not use anything we recover or provide to harass, stalk, blackmail, or otherwise harm another person.</li>
        </ul>
        <p style={s.p}>Where you have asked us to prepare evidence-grade documentation (for example, for use in legal proceedings), we will take reasonable steps to document our methodology and the chain of custody of the device or media while in our possession, but we do not guarantee that our documentation will meet the evidentiary standard of any particular court, tribunal, or jurisdiction, and you should obtain independent legal advice on evidentiary requirements before relying on it. We retain recovered data only as long as reasonably necessary to complete the job and deliver it to you, after which we securely delete it unless you ask us in writing to retain it for a further agreed period.</p>
        <p style={s.p}>If we reasonably suspect a forensics or data recovery request is intended to facilitate stalking, domestic violence, unauthorised surveillance, or another unlawful purpose, we may decline or stop the job under clause 4, and may report the matter to police without notice to you. To the extent permitted by law, you indemnify us against any claim, loss, or liability arising from a forensics or data recovery job we perform at your request where any part of this warranty is false.</p>
      </div>

      <div style={s.mt}><h3>7C. CCTV and Security Camera Installations</h3>
        <p style={s.p}>If you engage us to install or configure a CCTV or other security camera system, you are solely responsible for ensuring the system's placement, recording, and use complies with the <em>Surveillance Devices Act</em> (or equivalent legislation) of your state or territory, including any requirement to obtain consent before recording in an area where a person has a reasonable expectation of privacy, and any signage or notification requirements that apply to your premises. We will advise you of obvious compliance issues we notice during installation (for example, a camera angled into a neighbouring private property or a shared bathroom), but we are not lawyers and installing a system at your direction is not advice that the resulting use is lawful.</p>
        <p style={s.p}>To the fullest extent permitted by law, we are not liable for your use of an installed system in a manner that breaches applicable surveillance or privacy law, and you indemnify us against any claim arising from such use. We may decline to install a camera in a location or configuration that, in our reasonable opinion, is clearly intended for covert surveillance of another person without a lawful basis.</p>
      </div>
