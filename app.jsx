...
// Header, footer, nav config and cross-site URLs are shared with the Tools and
// Weather bundles, which present the same site from their own subdomains.
import {
  ShopContext, useShop, useShopInfo, useAnnouncement,
  PRIMARY_PAGES, UTILITY_PAGES, NAV_PAGE_ALIASES,
  isExternalLink, externalHref,
  getPortalUrl, getGamesUrl, getToolsUrl, getForumUrl,
  portalApi, usePortalUser,
  useFocusTrap, useBodyScrollLock,
  Logo, AccountDropdown, UtilityBar, MobileNavDrawer,
  SiteTopNav as TopNav, SiteFooter as Footer,
} from './site-chrome.jsx';
...
// pages-shop.jsx reaches for these off window rather than importing them.
